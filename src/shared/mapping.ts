...
export const FIELD_HINTS: Record<string, (keyof ProfileData)[]> = {
  ...
  "i have a preferred name": ["hasPreferredName"],
  "have a preferred": ["hasPreferredName"],
  "full name": ["fullName"],
  "email": ["email"],
  "phone": ["phoneNumber"],
  "mobile": ["phoneNumber"],
  "device type": ["phoneDeviceType"],
  "phone device": ["phoneDeviceType"],
  "phone type": ["phoneDeviceType"],
  ...
  "how did you learn": ["howDidYouHearAboutUs"],
  ...
  "previous employee": ["previouslyWorkedForCompany"],
  "employee or contractor": ["previouslyWorkedForCompany"],
  "worked as": ["previouslyWorkedForCompany"],
  "preferred name": ["hasPreferredName"],
  "use preferred": ["hasPreferredName"],
  "nickname": ["hasPreferredName"],
  "consider relocating": ["willingToRelocate"],
  "relocating for this role": ["willingToRelocate"],
  "willing to relocate": ["willingToRelocate"],
  "relocate": ["willingToRelocate"],
  "non-compete": ["nonCompeteRestrictions"],
  "non-solicitation": ["nonCompeteRestrictions"],
  "non compete": ["nonCompeteRestrictions"],
  "restrictions": ["nonCompeteRestrictions"],
  "workday system": ["workdaySystemExperience"],
  "work on the workday": ["workdaySystemExperience"],
  "use workday": ["workdaySystemExperience"],
  "authorized to work": ["workAuthorizedInCountry"],
  "work authorization": ["workAuthorizedInCountry"],
  "work in the country": ["workAuthorizedInCountry"],
  "visa sponsorship": ["requiresVisaSponsorship"],
  "immigration filing": ["requiresVisaSponsorship"],
  "work permit": ["requiresVisaSponsorship"],
  "permanent residency": ["requiresVisaSponsorship"],
  "federal government": ["federalGovernmentEmployee"],
  "u.s. federal": ["federalGovernmentEmployee"],
  "military officer": ["federalGovernmentEmployee"],
  "civilian equivalent": ["federalGovernmentEmployee"],
  "export control": ["exportControlCountries"],
  "iran, cuba, north korea": ["exportControlCountries"],
  "current citizen": ["exportControlCountries"],
  "related to a current workday": ["relatedToWorkdayEmployee"],
  "workday employee": ["relatedToWorkdayEmployee"],
  "related to an employee": ["relatedToCustomerEmployee"],
  "customer employee": ["relatedToCustomerEmployee"],
  "government official": ["relatedToCustomerEmployee"],
  "i acknowledge": ["acknowledgeTermsAndConditions"],
  "read, understood": ["acknowledgeTermsAndConditions"],
  "truthfully and accurately": ["acknowledgeTermsAndConditions"]
};
